...
def generate_pdf_invoice(request, id):
    ...
    selected_invoice.invoice_doc = SimpleUploadedFile(
        '{selected_business_account.name} Invoice-' + selected_invoice.invoice_id + '.pdf', pdf, content_type='application/pdf')
    selected_invoice.save()
    ################################################
...
def invoice_verification(request, id):
    if Invoice.objects.filter(invoice_id=id):
        context = {
            'invoice_id': id,
            'message_tag': "success",
            'message': "Verification Successful. This Invoice was generated by {selected_business_account.name}",
        }
        ...
        context = {
            'invoice_id': "",
            'message_tag': "warning",
            'message': "Verification not successful. This Invoice was NOT generated by {selected_business_account.name}",
        }
