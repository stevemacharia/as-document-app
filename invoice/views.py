        ...
        if invoice_form.is_valid():
            ...
            for i in range(form_count):
                ...
                if form.is_valid():
                    ...
                    return render(request, 'documents/invoice.html', context)
            ...
            if forms:
                ...
                template_name = get_template('documents/invoice_doc.html')
...
def invoice_details(request, id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid() and formset.is_valid():
            ...
            messages.warning(request, f'Failed to update invoices details, Kindly retry again.')
            return redirect('invoices')
    else:
    ...
    return render(request, 'documents/invoice_details.html', context)
...
def generate_pdf_invoice(request, id):
    ...
    context = {
        'selected_invoicen': selected_invoice,
        'listed_invoice_items': listed_invoice_items,
    }
    ...
    html_string = render_to_string('documents/invoice_doc.html', context)
...
def invoice_verification(request, id):
    if Invoice.objects.filter(id=id):
        ...
        messages.success(request, f'Verification Successful. This invoices was generated by Arieshelby LLC')
