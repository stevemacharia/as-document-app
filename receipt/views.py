    ...
    if request.method == 'POST':
        ...
        if receipt_form.is_valid() and all(f.is_valid() for f in forms):
            ...
            chosen_receipt.receipt_doc = SimpleUploadedFile(
                f'Arieshelby Receipt-{chosen_receipt.receipt_id}.pdf', pdf_file,
...
def generate_pdf_receip(request, id):
    ...
    selected_receipt.receipt_doc = SimpleUploadedFile(
        'Arieshelby Receipt-' + selected_receipt.receipt_id + '.pdf', pdf, content_type='application/pdf')
    selected_receipt.save()
    ################################################

    # Create a response object and specify the PDF content type
    response = HttpResponse(pdf, content_type='application/pdf')
    response['Content-Disposition'] = 'attachment; filename="Arieshelby Receipt-' + selected_receipt.receipt_id + '.pdf"'
...
def receipt_verification(request, id):
    if Receipt.objects.filter(receipt_id=id):
        context = {
            'receipt_id': id,
            'message_tag': "success",
            'message': "Verification Successful. This Receipt was generated by Arieshelby LLC",
        }
        # messages.success(request, f'Verification Successful. This receipt was generated by Arieshelby LLC')
        return render(request, 'receipt/receipt_confirmation.html', context)
    else:
        context = {
            'receipt_id': "",
            'message_tag': "warning",
            'message': "Verification not successful. This receipt was NOT generated by Arieshelby LLC",
        }
        # messages.warning(request, f'Verification not successful. This receipt was NOT generated by Arieshelby LLC')
        return render(request, 'receipt/receipt_confirmation.html', context)
